      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            <div class="row">
              <div class="col-3">
                <button type="button" class="btn btn-success mr20" onclick="add_campaign()">Add Banned IP's</button>
              </div>
            </div>
            <div class="card-header">
              <h3 class="card-title">Banned Ip's Table</h3>
            ...
            <div class="card-body table-responsive p-0">
              <table class="table table-hover table-striped">
                ...
                <?php 
                $i = 1;
                if($selectIp->num_rows > 0){
                while($fetchCate = $selectIp->fetch_array()){ 
                ?>
                  <tr>
                    <td><?= $i; ?></td>
...
<script>
  function add_campaign()
  {
    ...
    $(".modal-title").html("Add Banned Ip");
    $(".modal-body").html('<form><div class="form-group"><label for="exampleInputEmail1">Banned Ip</label><input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Banned Ip"><small id="emailHelp" class="form-text color-red">Banned Ip Add.</small></div></form>');
  ...
  function edit_catgory(data)
  {
    ...
    $(".modal-title").html("Edit banned Ip's");
  ...
  {
    $.ajax({
      url: 'ajax-page/view_bannedip.php',
      type: 'post',
      data: {data_val: data},
      dataType: 'json',
      success:  function(event)
