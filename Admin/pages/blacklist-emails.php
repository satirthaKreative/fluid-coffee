      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            <div class="row">
              <div class="col-3">
                <button type="button" class="btn btn-success mr20" onclick="add_campaign()">Add Blacklist Email's</button>
              </div>
            </div>
            <div class="card-header">
              <h3 class="card-title">Blacklist Emails</h3>
            ...
            <div class="card-body table-responsive p-0">
              <table class="table table-hover table-striped">
                ...
                while($fetchCate = $selectEmail->fetch_array()){ 
                ?>
                  <tr>
                    <td><?= $i; ?></td>
...
<script>
  function add_campaign()
  {
    ...
    $(".modal-title").html("Add Blacklist Email");
    $(".modal-body").html('<form><div class="form-group"><label for="exampleInputEmail1">Blacklist Email</label><input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Blacklist Email"><small id="emailHelp" class="form-text color-red">Blacklist Email Add.</small></div></form>');
  ...
  function save_data()
  {
    ...
    var action_type = 'add';
    $.ajax({
      url: 'ajax-page/Blacklistemail.php',
      type: 'post',
  ...
  function edit_catgory(data)
  {
    ...
    $(".modal-title").html("Edit Blacklist Emails");
  ...
  {
    $.ajax({
      url: 'ajax-page/view_blacklistemail.php',
      type: 'post',
      data: {data_val: data},
      dataType: 'json',
      success:  function(event)
